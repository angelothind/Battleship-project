...
def create_battleships(filename:str = "Battleship modules/componentfiles/battleships.txt"):
    """
...
def place_battleships(board, ships: dict, type:str ='simple'):
    ...
    if type == 'simple':
       ...
       for ship in ships:
        ...
        while ships_placed != len(ships):
            ...
            while ship_placed == False:
                ...
                if direction == 'horizontal':
                    column_limit = len(board) - ships[ship]
                    ...
                    row_limit = len(board) - ships[ship]
        ...
        with open('Battleship modules/componentfiles/placement.json','r') as file:
